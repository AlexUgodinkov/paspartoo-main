...
?>
    ...
    <div class="container page_header">
        <div class="row">
            <div class="col-12  text-center breadcrumbs padding-42">
...
<?php if (have_posts()) :  ?>
        <div class="row categories">
            <div class="col-12">
                ...
                <div class="row justify-content-center  padding-42 padding-42-bottom">
                    <div class="cat_but"><a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>">All</a></div>
                    <?php
                    foreach ($terms as $termses) :
                        $class="";
                        $queried_object = get_queried_object();
                        $term_id = $queried_object->term_id;
                         if ($term_id == $termses->term_id) $class='current';
