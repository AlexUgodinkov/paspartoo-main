...
if (class_exists('WPBakeryShortCode')) {
	class WPBakeryShortCode_vc_carousel_post extends WPBakeryShortCode {
		...
		protected function content( $atts, $content = null ) { 
			...
			$selected_style = dirname(__FILE__).'/post-templates/'.$wdo_post_style.'.php';
...
if ( function_exists( "vc_map" ) ) {
	vc_map( array(
		...
		'params' => array(
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Title Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Hover Title Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Description Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Read More Text Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Read More Text Hover Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
