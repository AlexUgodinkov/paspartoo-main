...
if ( function_exists( "vc_map" ) ) {
	vc_map( array(
		...
		'params' => array(
			...
			array(
				"type"       => "textfield",
				"heading"    => __( "AutoPlay Speed <strong><a href='https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed'>(PRO Feature)</a></strong>", "wdo-carousel" ),
			...
			array(
				"type"       => "dropdown",
				"heading"    => __( "AutoPlay HoverPause <strong><a href='https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed'>(PRO Feature)</a></strong>", "wdo-carousel" ),
			...
			array(
				"type"       => "textfield",
				"heading"    => __( "Navigation Speed <strong><a href='https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed'>(PRO Feature)</a></strong>", "wdo-carousel" ),
			...
			array(
				"type"       => "textfield",
				"heading"    => __( "Dots Pagination Speed <strong><a href='https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed'>(PRO Feature)</a></strong>", "wdo-carousel" ),
