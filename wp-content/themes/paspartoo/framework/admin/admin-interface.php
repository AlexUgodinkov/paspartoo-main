...
function siteoptions_add_admin() {
    ...
    $tt_page = add_theme_page( __('Theme Options','themename'), __('Theme Options','themename'), 'edit_theme_options', 'siteoptions','siteoptions_options_page');
...
function of_ajax_callback() {
	...
	elseif ($save_type == 'options' OR $save_type == 'themename' ) {
		...
		foreach($options as $option_array){
            ...
            $theme_phonesicon=$output['theme_phonesicon'];
			$phones=array();
			$i=1;
			foreach ($theme_phones as $key=>$block)
			{
				if ($block!='')
				{
                    ...
                    $phones[$i]['icon']=$theme_phonesicon[$key];
                    $i++;
				}
			}
...
function of_ajax_add_phones() {
    ...
    print '<div class="blockbigtitl"><div class="tables"><div class="tablestitlebig tdauto">'.__('Icon','themename').'</div><div class="tdauto">
	<input class="of-input" name="theme_phonesicon['.$countphones.']" type="text" value=""></div></div></div>';
...
$output .= '<div class="blockbig" id="countphones'.$countphones.'">';
	...
	$output .= '</div></div></div>';	
	$output .= '<div class="blockbigtitl"><div class="tables"><div class="tablestitlebig tdauto">'.__('Name for phone','themename').'</div><div class="tdauto">
	<input class="of-input" name="theme_phonesshort['.$countphones.']" type="text" value="'.$block['short'].'"></div></div></div>';
      $output .= '<div class="blockbigtitl"><div class="tables"><div class="tablestitlebig tdauto">'.__('Icon','themename').'</div><div class="tdauto">
	<input class="of-input" name="theme_phonesicon['.$countphones.']" type="text" value="'.$block['icon'].'"></div></div></div>';
