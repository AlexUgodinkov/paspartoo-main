...
if (class_exists('WPBakeryShortCode')) {
	class WPBakeryShortCode_vc_carousel_testimonial extends WPBakeryShortCode {
		...
		protected function content( $atts, $content = null ) {
			...
			$selected_style =dirname(__FILE__).'/testimonial-templates/'.$wdo_testimonial_style.'.php';
			?>
			<div class="item">
...
if ( function_exists( "vc_map" ) ) {
	vc_map( array(
		...
		'params' => array(
			...
			array(
				"type" 			=> 	"textfield",
				"heading" 		=> 	__( 'Author Postion <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"textfield",
				"heading" 		=> 	__( 'Author Website Link <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Author Name Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Author Postion Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
			...
			array(
				"type" 			=> 	"colorpicker",
				"heading" 		=> 	__( 'Testimonial Text Color <strong><a href="https://codecanyon.net/item/carousel-anything-for-visual-composer/23172506?ref=labibahmed">(PRO Feature)</a></strong>', 'wdo-carousel' ),
