...
function lmt_post_custom_text_display() {
    ...
    ?>  <input id="post-custom-text" name="lmt_plugin_global_settings[lmt_post_custom_text]" type="text" size="30" style="width:30%;" required placeholder="<?php _e( 'Last Updated on', 'wp-last-modified-info' ); ?>" value="<?php if (isset($options['lmt_post_custom_text'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_post_custom_text'] ) ); } ?>" />
...
function lmt_last_modified_format_post_display() {
    ...
    <span id="post-human-end-with" style="display:none;">&nbsp;&nbsp;<label for="post-ago-replace" style="font-size:13px;"><strong><?php _e( 'End with:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="post-ago-replace" name="lmt_plugin_global_settings[lmt_replace_ago_text_with]" type="text" size="10" style="width:10%;" required placeholder="ago" value="<?php if (isset($options['lmt_replace_ago_text_with'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_replace_ago_text_with'] ) ); } ?>" />
    </span>
...
function lmt_last_modified_default_format_post_display() {
    ...
    <span id="post-dtcf" style="display:none;">&nbsp;&nbsp;<label for="custom-post-date-format" style="font-size:13px;"><strong><?php _e( 'Date Format:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="custom-post-date-format" name="lmt_plugin_global_settings[lmt_custom_post_date_format]" type="text" size="8" style="width:8%;" required placeholder="F jS, Y" value="<?php if (isset($options['lmt_custom_post_date_format'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_custom_post_date_format'] ) ); } ?>" />
    </span>
    ...
    <span id="post-dtsep" style="display:none;">&nbsp;&nbsp;<label for="custom-post-dtsep" style="font-size:13px;"><strong><?php _e( 'Separator:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="custom-post-dtsep" name="lmt_plugin_global_settings[lmt_post_date_time_sep]" type="text" size="6" style="width:6%;" required placeholder="at" value="<?php if (isset($options['lmt_post_date_time_sep'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_post_date_time_sep'] ) ); } ?>" />
    </span>
    ...
    <span id="post-tmcf" style="display:none;">&nbsp;&nbsp;<label for="custom-post-time-format" style="font-size:13px;"><strong><?php _e( 'Time Format:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="custom-post-time-format" name="lmt_plugin_global_settings[lmt_custom_post_time_format]" type="text" size="8" style="width:8%;" required placeholder="h:i a" value="<?php if (isset($options['lmt_custom_post_time_format'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_custom_post_time_format'] ) ); } ?>" />
    </span>
...
function lmt_show_author_cb_display() {
    ...
    <input id="custom-post-author-sep" name="lmt_plugin_global_settings[lmt_post_author_sep]" type="text" size="6" style="width:6%;" placeholder="by" required value="<?php if (isset($options['lmt_post_author_sep'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_post_author_sep'] ) ); } ?>" />
    </span>
...
function lmt_page_custom_text_display() {
    ...
    ?> <input id="page-custom-text" name="lmt_plugin_global_settings[lmt_page_custom_text]" type="text" size="30" style="width:30%;" required placeholder="<?php _e( 'Last Updated on', 'wp-last-modified-info' ); ?>" value="<?php if (isset($options['lmt_page_custom_text'])) { echo htmlspecialchars( wp_kses_post($options['lmt_page_custom_text']) ); } ?>" />
...
function lmt_last_modified_format_page_display() {
    ...
    <span id="page-human-end-with" style="display:none;">&nbsp;&nbsp;<label for="page-ago-replace" style="font-size:13px;"><strong><?php _e( 'End with:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="page-ago-replace" name="lmt_plugin_global_settings[lmt_replace_ago_text_with_page]" type="text" size="10" style="width:10%;" required placeholder="ago" value="<?php if (isset($options['lmt_replace_ago_text_with_page'])) { echo htmlspecialchars( wp_kses_post($options['lmt_replace_ago_text_with_page']) ); } ?>" />
    </span>
    &nbsp;&nbsp;</span><span class="tooltip" title="<?php _e( 'Select last modified info format from here.', 'wp-last-modified-info' ); ?>"><span title="" class="dashicon dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_last_modified_default_format_page_display() {
    ...
    <span id="page-dtsep" style="display:none;">&nbsp;&nbsp;<label for="custom-page-dtsep" style="font-size:13px;"><strong><?php _e( 'Separator:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="custom-page-dtsep" name="lmt_plugin_global_settings[lmt_page_date_time_sep]" type="text" size="6" style="width:6%;" required placeholder="at" value="<?php if (isset($options['lmt_page_date_time_sep'])) { echo htmlspecialchars( wp_kses_post($options['lmt_page_date_time_sep']) ); } ?>" />
    </span>
...
function lmt_show_author_page_cb_display() {
    ...
    <input id="custom-page-author-sep" name="lmt_plugin_global_settings[lmt_page_author_sep]" type="text" size="6" style="width:6%;" placeholder="by" required value="<?php if (isset($options['lmt_page_author_sep'])) { echo htmlspecialchars( wp_kses_post($options['lmt_page_author_sep']) ); } ?>" />
    </span>
...
function lmt_tt_updated_text_box_display() {
    $options = get_option('lmt_plugin_global_settings');
    ?> <input id="lmt-tt-updated-text" name="lmt_plugin_global_settings[lmt_tt_updated_text_box]" type="text" size="40" style="width:40%;" placeholder="Updated on" value="<?php if (isset($options['lmt_tt_updated_text_box'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_tt_updated_text_box'] ) ); } ?>" />
...
function lmt_last_modified_format_tt_display() {
    ...
    <span id="tt-human-end-with" style="display:none;">&nbsp;&nbsp;<label for="tt-ago-replace" style="font-size:13px;"><strong><?php _e( 'End with:', 'wp-last-modified-info' ); ?></strong></label>&nbsp;&nbsp;
        ...
        <input id="tt-ago-replace" name="lmt_plugin_global_settings[lmt_replace_ago_text_with_tt]" type="text" size="10" style="width:10%;" required placeholder="ago" value="<?php if (isset($options['lmt_replace_ago_text_with_tt'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_replace_ago_text_with_tt']) ); } ?>" />
    </span>
    &nbsp;&nbsp;</span><span class="tooltip" title="<?php _e( 'Select last modified info format from here.', 'wp-last-modified-info' ); ?>"><span title="" class="dashicon dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_show_author_tt_cb_display() {
    ...
    <input id="custom-tt-author-sep" name="lmt_plugin_global_settings[lmt_tt_author_sep]" type="text" size="6" style="width:6%;" placeholder="by" required value="<?php if (isset($options['lmt_tt_author_sep'])) { echo htmlspecialchars( wp_kses_post($options['lmt_tt_author_sep']) ); } ?>" />
    </span>
...
function lmt_email_subject_display() {
    ...
    ?> <input id="email-sub" name="lmt_plugin_global_settings[lmt_email_subject]" type="text" size="100" style="width:100%;" value="<?php if (isset($options['lmt_email_subject'])) { echo htmlspecialchars( wp_kses_post( $options['lmt_email_subject'] ) ); } ?>" />
        <br>
    <?php printf(
