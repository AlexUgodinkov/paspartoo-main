...
class GF_Installation_Wizard_Step_License_Key extends GF_Installation_Wizard_Step {
	...
	function display() {
		...
		<div>
			<input type="text" class="regular-text" id="license_key" value="<?php echo esc_attr( $this->license_key ); ?>" name="license_key" placeholder="Please Enter 'GPLPlus' for License Key" />
			<?php
