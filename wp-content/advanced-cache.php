...
$nitropack_functions_file = '/home/admin/web/paspartoo.com/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/admin/web/paspartoo.com/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_459c3dc565ba4b44a4cb754eaf31039e' );
